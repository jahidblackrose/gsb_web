...
<!-- Hotjar Tracking Code for http://imstriker.com/gsb6/ -->
<script>
    (function(h,o,t,j,a,r){
        h.hj=h.hj||function(){(h.hj.q=h.hj.q||[]).push(arguments)};
        h._hjSettings={hjid:1232153,hjsv:6};
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="probootstrap-service-2 probootstrap-animate">
                ...
                <div class="text">
                  <span class="probootstrap-meta"><i class="icon-calendar2"></i> July 1, 2019</span>
                    <h3>MBA</h3>
          ...
          <div class="row">
            <div class="col-md-12 col-sm-6">
              <div class="probootstrap-teacher text-center probootstrap-animate">
                ...
                <div class="text">
                  <h3>Prof. Azlan Amran</h3>
                  <p>Dean</p>
                  <ul class="probootstrap-footer-social">
                    <li class="twitter"><a href="http://www.gsb.usm.my/index.php/our-people/faculty/dr-azlan-amran"><i class="icon-book"></i></a></li>
            ...
            <div class="col-md-3 col-sm-6">
              <div class="probootstrap-teacher text-center probootstrap-animate">
                ...
                <div class="text">
                  <h3>Dr. Christopher Richardson</h3>
          ...
          <div class="row">
            <div class="col-md-3 col-sm-6">
              <div class="probootstrap-teacher text-center probootstrap-animate">
                ...
                <div class="text">
                  <h3>Dr. Zurina Mohaidin<br> </br></h3>
            ...
            <div class="col-md-3 col-sm-6">
              <div class="probootstrap-teacher text-center probootstrap-animate">
                ...
                <div class="text">
                  <h3>Dr. Rosly Othman<br> </br></h3>
                  <p>OMBA Progamme Manager</p>
                  <ul class="probootstrap-footer-social">
                    <li class="twitter"><a href="#"><i class="icon-book"></i></a></li>
                    <li class="facebook"><a href="rosly@usm.my"><i class="icon-mail"></i></a></li>
            ...
            <div class="col-md-3 col-sm-6">
              <div class="probootstrap-teacher text-center probootstrap-animate">
                ...
                <div class="text">
                  <h3>Dr. Junaimah Jauhar <br> </br></h3>
