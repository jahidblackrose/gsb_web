          ...
          <li style="background-image: url(img/slider_2.jpg)" class="overlay">
            <div class="container">
              <div class="row">
                <div class="col-md-8 col-md-offset-2">
                  <div class="probootstrap-slider-text text-center">
                    <h1 class="probootstrap-heading probootstrap-animate">Nurturing Business Sustainability</h1>
                  </div>
                </div>
              </div>
            </div>
             ...
             <div class="col-md-6">
              <div class="probootstrap-service-2 probootstrap-animate">
                ...
                <div class="text">
                  ...
                  <p align="justify"><b>The MBA_MSc (Double Degree) programme is a two-years degree, with the first year studying MBA at Graduate School of Business, USM. In the second year, students will have the opportunity to travel to Glasgow to

study one of the three MSc programmes on offer: Corporate Governance & Accountability; Environment & Sustainability Development; or International Strategic Marketing at Adam Smith Business School, University of Glasgow.</b></p>
                  <p> </p>
            ...
            <div class="col-md-6">
              <div class="probootstrap-service-2 probootstrap-animate">
                ...
                <div class="text">
                    ...
                    <h3><strong>PhD- HKMA</strong></h3>
                  <p align="justify"><b>Universiti Sains Malaysia (USM) offers a Doctor of Philosophy (PhD) programme in Hong Kong through the cooperation and collaboration between USM’s Graduate School of Business (GSB) and the Hong Kong Management Association (HKMA). The purpose of the programme is to provide education and research training in business, leading leading to the award of the Doctor of Philosophy (PhD) degree by USM.</b></p>
                  <p> </p>
              ...
              <div class="probootstrap-service-2 probootstrap-animate">
                ...
                <div class="text">
                    ...
                    <h3><strong>EDP</strong></h3>
                  <p align="justify"><b>The EDP is the consulting arm for the Graduate School of Business. It is the provider of professional development programs. It is a research and consultancy center that undertakes standards development, quality review, and data management (surveys, collection, analysis, distribution, and publication). The EDP is also a provider of services to support entrepreneurship, strategic planning, value-chain business etc. </b></p>
                  <p> </p>
          ...
          <div class="row">
            ...
            <div class="col-md-3 col-sm-6">
              <div class="probootstrap-teacher text-center probootstrap-animate">
                ...
                <div class="text">
                  <h3><b>Assoc Prof. Dr. Junaimah Jauhar</b> <br> </br></h3>
