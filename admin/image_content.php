...
$slid=$_POST['slid'];
$SQL="UPDATE  cms_settings_new SET image= '$newname' WHERE  sl='$slid'";
//	die($SQL) ;
...
<div class="wrap">
 ...
 ?>
             ...
             <?php if ($a!=NULL) { ?>
						...
						<?php } ?>
              </div>	<form action="image_content.php?ID=<?php echo $sli ; ?>" method="post" enctype="multipart/form-data">
                  
<input type="hidden" name="slid" value="<?php echo $sll ; ?>" />							
